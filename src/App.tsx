...
export default function App() {
  ...
  const triggerWhatsAppDirect = (customText?: string) => {
    const defaultText = `Hi, I want to book Kings Diamonds Villa Lonavala. Please let me know rates and check-in availability!`;
    ...
    <div className="min-h-screen bg-[#0D1117] text-[#FAF6EE] select-none font-sans antialiased relative">
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-[1000] bg-[#0D1117] flex flex-col items-center justify-center p-6 text-center animate-[fadeIn_0.3s_ease]">
          ...
          <div className="mb-10">
            ...
            <h3 className="font-display text-[#F0D080] font-bold text-xl">{BRAND_NAME}</h3>
          ...
          <p className="text-[10px] text-[#FAF6EE]/40 mt-6 font-light">
            Owned and monitored directly by {OWNER_NAME}
          </p>
      ...
      <header id="home" className="relative min-h-screen flex items-center justify-center bg-black overflow-hidden pt-12">
        ...
        <div 
          ...
          style={{
            backgroundImage: "linear-gradient(to bottom, rgba(13,17,23,0.45) 0%, rgba(13,17,23,0.95) 100%), url('/images/hero.jpg')"
          }}
        />
        ...
        <div className="max-w-4xl mx-auto px-6 text-center z-10 flex flex-col items-center justify-center">
          ...
          {/* Shimmer animation headline with Playfair Serif */}
          ...
          {/* Subheadline in elegant Cormorant italic */}
          <p className="reveal-hidden subheading-cormorant text-lg sm:text-2xl md:text-3xl text-[#FAF6EE]/90 italic max-w-3.5xl mb-10 leading-relaxed font-light font-serif-elegant">
            "A private 4BHK luxury villa with infinity pool, mountain views & golden memories — just 90 minutes from Mumbai & Pune"
          </p>
          ...
          <div className="reveal-hidden flex flex-wrap justify-center items-center gap-3 sm:gap-4 md:gap-5 mb-12 text-xs md:text-sm font-sans">
            ...
            <span className="px-3.5 py-1.5 rounded-full bg-[#141B26]/80 backdrop-blur-md border border-[#C9A84C]/15 text-[#52B788] font-medium inline-flex items-center gap-1">
              🐾 Pet Friendly
            </span>
          </div>
          ...
          <div className="reveal-hidden flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <button
              onClick={() => triggerWhatsAppDirect("Hi, I want to book my villa getaway! Can you check availability?")}
      ...
      {/* SECTION 3 — SOCIAL PROOF BAR (Thin strip with mobile horizontal auto-scrolling) */}
      <section className="bg-[#141B26] border-y border-[#C9A84C]/25 py-4 overflow-hidden shadow-inner font-sans">
        <div className="max-w-7xl mx-auto px-6">
          <div className="hidden md:flex justify-around items-center text-xs tracking-wider font-medium text-[#FAF6EE]/90">
            ...
            <span className="text-[#C9A84C]/50">◆</span>
            <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-[#F0D080] transition-colors">
              <span className="text-[#C9A84C]">📲</span> {INSTAGRAM_HANDLE} on Instagram
            </a>
          </div>
          ...
          <div className="md:hidden overflow-x-auto whitespace-nowrap scrollbar-hide py-1">
            <div className="inline-flex gap-8 text-xs tracking-wide text-[#FAF6EE]/90 animate-[marquee_20s_linear_infinite]">
              ...
              <span className="text-[#C9A84C]">◆</span>
              <span className="inline-flex items-center gap-1.5">📲 Instagram: @kings_diamonds_villas</span>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* SECTION 4 — VILLA INTRO / ABOUT (Two-column layout, image left & copy right) */}
      <section id="about" className="py-24 bg-[#0D1117] border-b border-[#C9A84C]/10 scroll-mt-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            
            {/* Left Column: Image with offset golden border */}
              ...
              <div className="relative mx-auto max-w-md lg:max-w-none pr-4 pb-4">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl z-10 aspect-[4/5] object-cover">
                  <LazyImage
                    ...
                    alt="Kings Diamonds Villa Entrance"
            ...
            {/* Right Column: Copy & core details */}
            <div className="lg:col-span-7 space-y-6 reveal-hidden">
              ...
              <h2 className="text-3xl md:text-5xl font-display font-medium text-[#FAF6EE]">
                Your Private Kingdom <br />in the Hills
              </h2>
              ...
              <div className="text-sm md:text-base text-[#FAF6EE]/80 leading-relaxed space-y-5 font-light">
                <p>
                  ...
                  <strong className="text-[#F0D080] font-medium"> Kings Diamonds Villa</strong> is not just a place to stay. It is a feeling. 
              ...
              {/* Stats highlights boxes with thin gold rims */}
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6">
                ...
                <div className="p-4 bg-[#141B26] border border-[#C9A84C]/25 rounded-2xl text-center">
                  <p className="text-[#F0D080] font-display font-bold text-lg sm:text-2xl">16 Guests</p>
      ...
      {/* SECTION 5 — AMENITIES (Icon grid inside luxurious cards) */}
      <section id="amenities" className="py-24 bg-[#141B26] border-b border-[#C9A84C]/10 scroll-mt-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {/* Highlight Add-On Package Callout box */}
      ...
      {/* SECTION 6 — ROOMS SHOWCASE (Bespoke tabbed module) */}
      <RoomsShowcase />


      {/* SECTION 7 — GALLERY (Masonry with pure-JS details lightbox) */}
      <Gallery />


      {/* SECTION 8 — EXPERIENCES / USE CASES (Emotion-driven scenic imagery cards) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {EXPERIENCE_CARDS.map((exp, i) => (
              ...
              >
                ...
                {/* Image Backdrop with lazy sizing */}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 flex flex-col justify-end text-left z-10">
                  ...
                  {/* Subtle chevron prompt on hover */}
      ...
      {/* SECTION 9 — LOCATION & DISTANCE CHART */}
      <section className="py-24 bg-[#141B26] border-b border-[#C9A84C]/10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            
            {/* Left Column: Local static map and Google Maps CTA */}
            <div className="lg:col-span-5 space-y-6 reveal-hidden">
              ...
              {/* Map Thumbnail mockup container */}
              <div className="rounded-2xl overflow-hidden border border-[#C9A84C]/30 shadow-2xl h-80 relative group">
                <LazyImage
                  src="/images/map-thumb.jpg"
                  alt="Static map layout of Malavali, Lonavala"
                  fallbackType="map"
                  className="w-full h-full"
                />
                
                {/* Floating Map Pin logo */}
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-6 select-none">
                  <div className="flex gap-3 items-center">
                    ...
                    <div>
                      <p className="font-sans font-bold text-[#FAF6EE] text-sm">Kings Diamonds Villas</p>
              ...
              {/* Real URL Open Button */}
              <a
                href="https://maps.google.com/?q=Kings+Diamonds+Villas+Malavali+Lonavala"
                target="_blank"
                rel="noreferrer"
            ...
            {/* Right Column: Address and Tourist Attraction targets */}
            <div className="lg:col-span-7 space-y-8 reveal-hidden">
              <div>
                ...
                <p className="text-xs sm:text-sm text-[#F0D080] antialiased leading-relaxed">
                  📍 Address: Malavali, Boraj Road, Near Railway Station crossing, Lonavala, Maharashtra 410405
                </p>
              </div>

              {/* Distance callouts row */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto items-center">
            ...
            <div className="bg-[#141B26] border border-[#C9A84C]/15 rounded-3xl p-8 hover:border-[#C9A84C]/35 transition-all duration-300">
              ...
              <div className="flex items-baseline gap-1.5 my-6">
                <span className="text-4xl font-sans font-extrabold text-[#F0D080]">₹2,500</span>
                <span className="text-xs text-[#FAF6EE]/60">/ person / night</span>
              </div>
              ...
              <button
                onClick={() => triggerWhatsAppDirect("Hi, I want to check weekday booking rates for Kings Diamonds Villa!")}
            ...
            {/* Weekend Pricing (Highlighted with shadow glow) */}
            <div className="bg-[#141B26] border-[2px] border-[#C9A84C] rounded-3xl p-8 relative hover:shadow-[0_12px_45px_rgba(201,168,76,0.18)] transition-all duration-400 scale-100 md:scale-105">
              ...
              <div className="flex items-baseline gap-1.5 my-6">
                <span className="text-4xl font-sans font-extrabold text-[#F0D080]">₹3,500</span>
                <span className="text-xs text-[#FAF6EE]/60">/ person / night</span>
              </div>
              ...
              <button
                onClick={() => triggerWhatsAppDirect("Hi, I want to book a weekend slot! Can you verify availability?")}
          ...
          <div className="mt-16 bg-[#141B26] border border-[#C9A84C]/30 rounded-3xl p-6 md:p-10 max-w-4xl mx-auto">
            <h4 className="font-sans font-semibold text-[#FAF6EE] text-sm md:text-base text-center uppercase tracking-widest mb-6 flex items-center justify-center gap-2">
              📂 BOOKING & SECURITY POLICIES
            </h4>
            
            {/* Grid checklist bullet */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-[#FAF6EE]/80 leading-relaxed font-sans">
              <div className="flex gap-2 items-start">
                <span className="text-[#C9A84C] mt-0.5">◆</span> <span><strong>50% advance</strong> to block dates and confirm booking calendar.</span>
              </div>
              <div className="flex gap-2 items-start">
                <span className="text-[#C9A84C] mt-0.5">◆</span> <span>Remaining balance fully payable at check-in desk on arrival.</span>
              </div>
              <div className="flex gap-2 items-start">
                <span className="text-[#C9A84C] mt-0.5">◆</span> <span>All payment forms accepted (UPI, Wire Transfer, Cash).</span>
              </div>
              <div className="flex gap-2 items-start">
                <span className="text-[#C9A84C] mt-0.5">◆</span> <span>Valid Government-signed photo ID card mandatory for check-in.</span>
              </div>
              <div className="flex gap-2 items-start">
                <span className="text-[#C9A84C] mt-0.5">◆</span> <span>Security Deposit (Refundable on checkout post-assessment).</span>
              </div>
              <div className="flex gap-2 items-start">
                <span className="text-[#C9A84C] mt-0.5">◆</span> <span>Standard Hours &bull; Check-in 1:00 PM | Checkout 11:00 AM.</span>
              </div>
              <div className="flex gap-2 items-start">
                <span className="text-[#C9A84C] mt-0.5">◆</span> <span>Loud music outdoor strictly capped until 10:00 PM per local laws.</span>
              </div>
              <div className="flex gap-2 items-start">
                <span className="text-[#C9A84C] mt-0.5">◆</span> <span>No smoking inside the air-conditioned bedrooms or pool water.</span>
              </div>
            </div>

            <p className="text-center font-serif-elegant italic text-xs text-[#FAF6EE]/50 mt-8 border-t border-[#C9A84C]/10 pt-6">
              * Rates could reflect slight peak increases during heavy national holidays, long monsoonal weekends & festival seasons. Call directly to negotiate group packages.
            </p>
          </div>

          {/* Epic Instant Quote CTA */}
          <div className="text-center mt-12">
            <button
              onClick={() => triggerWhatsAppDirect("Hi, I am looking for a direct quote for Kings Diamonds Villa!")}
      ...
      {/* SECTION 11 — REVIEWS CAROUSEL Testimonials block */}
      <ReviewsCarousel />


      {/* SECTION 13 — CONTACT & DYNAMIC WHATSAPP PRE-FILL FORM */}
      <EnquiryForm />
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center bg-[#141B26]/30 p-8 rounded-3xl border border-[#C9A84C]/15 mb-12 gap-6 text-center md:text-left">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-display font-bold text-lg text-[#F0D080] tracking-wide">{BRAND_NAME}</h4>
                <p className="subheading-cormorant italic text-[#FAF6EE]/60 text-sm mt-0.5">"Live Like Royalty in Lonavala"</p>
              </div>
            </div>
            
            <button
              onClick={() => triggerWhatsAppDirect("Hi! I want to inquire about package pricing.")}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 pb-12 text-[#FAF6EE]/80">
            ...
            <div className="space-y-4 text-xs font-light">
              ...
              <p className="leading-relaxed">
                🎯 Owner: <span className="text-[#F0D080] font-medium">{OWNER_NAME}</span> <br />
                📲 Phone: +91 72081 62620 <br />
                📸 Instagram: <a href="https://www.instagram.com/kings_diamonds_villas/" target="_blank" rel="noopener noreferrer" className="text-[#C9A84C] hover:underline">@kings_diamonds_villas</a>
              </p>
              <p className="leading-relaxed">
                📍 Location: Malavali, Boraj Road crossing, Lonavala, Maharashtra, India, Pin 410405
              </p>
            </div>
            ...
            <div className="space-y-4 text-xs font-light leading-relaxed">
              ...
              <p>
                ⏳ Checking Protocol: Direct-to-caretaker handoffs. Check-in strictly at 1:00 PM, and checkout strictly at 11:00 AM.
              </p>
            </div>
          ...
          <div className="pt-8 border-t border-[#C9A84C]/20 text-center text-[#FAF6EE]/40 text-[11px] font-light flex flex-col sm:flex-row justify-between items-center gap-4">
            <p>
              &copy; {new Date().getFullYear()} Kings Diamonds Villas &bull; Malavali, Lonavala. All Rights Reserved.
            </p>
            <p className="flex items-center gap-1">
              Designed with 💛 in Maharashtra, India &bull; Administered by Shadab Khan
            </p>
          </div>
      ...
      <div className="fixed bottom-6 right-6 z-[9999] group">
        <button
          onClick={() => triggerWhatsAppDirect("Hi! I'm interested in booking Kings Diamonds Villa. Please share availability & price quote.")}
