      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
          {images.map((img, idx) => (
            <div
              key={img.id}
              className={`break-inside-avoid relative overflow-hidden rounded-2xl border border-[#C9A84C]/10 bg-[#141B26] cursor-pointer group hover:border-[#C9A84C]/30 hover:shadow-[0_8px_32px_rgba(201,168,76,0.12)] transition-all duration-300 transform hover:-translate-y-1 ${img.aspect}`}
